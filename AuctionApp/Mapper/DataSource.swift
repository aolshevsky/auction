...
class DataSource {
    ...
    private func createAuctions() -> [Auction] {
        ...
        let auction4 = Auction(imageUrl: "https://firebasestorage.googleapis.com/v0/b/auction-42d96.appspot.com/o/auction_5?alt=media&token=6e436be3-95f6-4879-80ed-58b7903a91d6", title: "Тачка прадеда", price: 3220, status: AuctionStatus.completed, isStar: true)
        let auction5 = Auction(imageUrl: "https://firebasestorage.googleapis.com/v0/b/auction-42d96.appspot.com/o/auction_2?alt=media&token=4734663a-706a-4c4d-b5e6-61c40e376986", title: "Тачка бабули", price: 890, status: AuctionStatus.completed, isStar: false)
